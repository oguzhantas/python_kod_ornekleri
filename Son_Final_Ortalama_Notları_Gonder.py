...
gonderen_sifre = 'akfiat71..' #e-posta şifreniz
csv_dosya="final_notlari.csv" #Göndereceğiniz CSV dosyası, Excel'de farklı kaydet seçip CSV formatında kaydedebilirsiniz.
